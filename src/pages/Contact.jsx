          ...
          {infoCards.map(({ icon, label, val, href }) => (
            ...
            >
              ...
              <div className="info-card-text">
                ...
                <div className="info-card-value">{val}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="contact" style={{ paddingTop:0 }}>
        <div className="contact-grid" style={{ marginTop:0 }}>
          <div>
            ...
            <p className="sec-sub contact-sec-sub">
            ...
            <div className="next-steps-box">
              <h4 className="next-steps-title">What happens after you submit?</h4>
              {(ct.nextSteps || [
          ...
          <div className="contact-form-wrap">
            {submitted ? (
              <div className="success-message">
                ...
                <p className="success-text">Thank you! We'll get back to you within 2 hours on business days.</p>
                <button className="btn-primary success-btn" onClick={() => navigate("how")}>How It Works</button>
              </div>
            ) : (
              <form onSubmit={submit}>
                ...
                <p className="form-footer">We'll respond within 2 business hours. No spam, ever.</p>
              </form>
            )}
          </div>
        </div>
